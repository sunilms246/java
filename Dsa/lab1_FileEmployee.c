// LAB PROGRAM1: Develop a C program to create a sequential file for 
// storing employee records with each record having following information:
...
// c) Search for specific records based on Department. In case if the 
// required record is not found, suitable message should be displayed.
#include<stdio.h> 
#include<stdlib.h> 
#include<string.h>
struct EMPLOYEE
